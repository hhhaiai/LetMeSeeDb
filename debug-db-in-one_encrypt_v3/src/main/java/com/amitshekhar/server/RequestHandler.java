...
public class RequestHandler {
    ...
    //Update for account. https://github.com/amitshekhariitbhu/Android-Debug-Database/issues/211
    ...
    public RequestHandler(Context context, DBFactory dbFactory) {
        ...
        //Update for account. https://github.com/amitshekhariitbhu/Android-Debug-Database/issues/211
        basicAuthAdminPW = context.getString(com.amitshekhar.R.string.BASIC_AUTH_ADMIN_PW);
    }
