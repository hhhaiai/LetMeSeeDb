    ...
    public static List<Map<String, Object>> getPrefData(String prefname) {
        ...
        for (Map.Entry<String, ?> entry : entries.entrySet()) {
            ...
            if (entry.getValue() instanceof Integer) {
                map.put("dataType", Constant.INTEGER);
            } else if (entry.getValue() instanceof Long) {
                map.put("dataType", Constant.LONG);
            } else if (entry.getValue() instanceof Float) {
                map.put("dataType", Constant.FLOAT);
            } else if (entry.getValue() instanceof Boolean) {
                map.put("dataType", Constant.BOOLEAN);
            } else if (entry.getValue() instanceof Set) {
                map.put("dataType", Constant.STRING_SET);
            } else {
                map.put("dataType", Constant.TEXT);
            }
            datas.add(map);
        }
        return datas;
