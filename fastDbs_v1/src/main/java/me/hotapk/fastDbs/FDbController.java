...
import me.hotapk.fhttpserver.annotation.RequestMapping;
import me.hotapk.fhttpserver.annotation.RequestParam;
import me.hotapk.fhttpserver.annotation.ResponseBody;
...
public class FDbController {
    ...
    public NanoHTTPD.Response downloaddb(@RequestParam("dbname") String dbname) {
        ...
        if (dbname.contains(Constant.SHAREDPREFS_XML)) {
            dbname = dbname.replace(Constant.SHAREDPREFS_XML, "");
        }
